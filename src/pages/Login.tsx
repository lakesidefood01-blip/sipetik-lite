    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/40 px-4 py-12">
      <div className="w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-muted-foreground">Manajemen sapi modern untuk peternak cerdas.</p>
        </div>
        ...
        <Card className="border-none shadow-xl">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" size="sm" className="text-xs text-primary hover:underline">Lupa password?</Link>
                </div>
                <Input 
                  id="password" 
                  type="password" 
          ...
          <CardFooter className="flex flex-wrap items-center justify-center gap-2">
            ...
            <Link to="/register" className="text-sm font-medium text-primary hover:underline">Daftar Sekarang</Link>
          </CardFooter>
        </Card>
      </div>
    </div>
